...
<HEAD>
	...
	<LINK href="${pageContext.request.contextPath}/client/admin/css/Style.css" type="text/css" rel="stylesheet">
	<script language="javascript" src="${pageContext.request.contextPath}/client/admin/js/public.js"></script>
	<script language="javascript" src="${pageContext.request.contextPath}/client/admin/js/check.js"></script>
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<TR>
				<td align="center" colSpan="4" class="sep1">
					<img src="${pageContext.request.contextPath}/client/admin/images/shim.gif">
				</td>
			</TR>
			<tr>
